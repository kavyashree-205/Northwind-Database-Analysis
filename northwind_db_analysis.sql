...
-- 12. Write an sql query to find how many purchase orders
-- have been placed for products supplied by each supplier?
-- products,purchase orders, inventory transactions,suppliers
